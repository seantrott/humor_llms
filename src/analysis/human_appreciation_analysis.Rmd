...
cor.test(df_merged_surprisal$Spreadsheet..Surprisal, df_merged_surprisal$surprisal)
```
...
And finally, exhibiting the **bias** LLMs have towards "no" responses overall.
